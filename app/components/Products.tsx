...
function Products() {
    ...
    return(
        <div id="products" className="products-container flex flex-col text-white mt-24 rounded-xl md:w-full h-[50rem] md:h-min-contact md:pt-5 md:pb-14">
            ...
            <div className="bottom mt-2 container md:flex-col w-[80%] md:w-full mx-auto">
                ...
                <div className="right w-[80%] md:w-full container">
                    ...
                    <Link href="/Products"><button className="fixed-btn absolute right-10 top-[14rem] md:top-[10rem] md:right-7 w-[13rem] py-2 rounded-[10px] bg-black text-white text-xl md:text-[18px] md:">More Products...</button></Link>
                </div>
